...
import com.example.project_gemini.databinding.LayoutCardItemBinding
import com.google.firebase.firestore.FirebaseFirestore

class CardAdapter(private val cardItems: List<CardItem>, private val contactNumber: String) :
    ...
    inner class CardViewHolder(private val binding: LayoutCardItemBinding) :
        ...
        private fun navigateToShowCardDetails(cardItem: CardItem) {
            ...
            val intent = Intent(itemView.context, ShowCardDetailsAct::class.java).apply {
                ...
                putExtra("contactNumber", contactNumber) // Pass the contactNumber to ShowCardDetailsAct
            }
